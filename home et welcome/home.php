...
<head>
  ...
  if (list1.includes(searchValue.toLowerCase())) {
    ...
    window.location.href = "../pagesProduits/sport2.php";
  }
...
<body>
        ...
        <nav class="navbar">
            <ul>
                <li><a href="home.php">COMPRASS</a></li>
            </ul>
            <ul>
            ...
            <ul>
                <li><a href="home.php">Hello, <?php echo $user ?> </a></li>
            </ul>
            <ul>
    ...
    <main>
        <div class="main-content">
            <aside class="sidebar">
              <ul>
                <br><br><li><a href="../pagesProduits/beauté2.php">beauté</a></li><br><br>
                <li><a href="../pagesProduits/sport2.php">sport</a></li><br><br>
                <li><a href="../pagesProduits/téléphone2.php">telephones et tablettes</a></li><br><br>
                <li><a href="../pagesProduits/mode2.php">mode</a></li><br><br>
                <li><a href="../pagesProduits/maison2.php">maison et decore</a></li><br><br>
                <li><a href="../pagesProduits/santé2.php">santé</a></li><br><br>
            </ul>
            </aside>
