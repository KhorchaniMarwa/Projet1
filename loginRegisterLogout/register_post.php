...
if(isset($_POST['submit'])){
   ...
   if(isset($_POST['gender'])){
    ...
    if($num_rows!=0){
      $user_error = '<p id="error">sorry username already exist, change another username </p>';
      $err_s = 1 ;
    }
   ...
   elseif(strlen($password)<6){
       ...
       if(($err_s == 0) && ($num_rows==0)){
        $sql = "INSERT INTO users(username,email,password,gender,birthday,md5_pass) VALUES ('$username','$email','$password','$gender','$birthday','$md5_pass')" ;
