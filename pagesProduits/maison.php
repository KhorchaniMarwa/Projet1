        ...
        <div class="main-content">
            ...
            <section class="products">
              ...
              <div class="product">
                ...
                <span>9.90 TND</span> <br><br><center><button onclick="ajout()"  class="ajouter"> ajouter au panier</button> </center>
              </div>
              ...
              <div class="product">
                ...
                <span>17.99 TND</span> <br><br><center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
              ...
              <div class="product">
                ...
                <span>208.00 TND</span><br><br> <center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
              ...
              <div class="product">
                ...
                <span>2,475.00 TND</span><br><br> <center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
                <img src="../produits/mai8.jpg" alt="Product 2">
                <h3>Cookart Poêle </h3>
                <p>26cm - Antiadhésive - Noir</p>
                <span>15.98 TND</span><br><br> <center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
