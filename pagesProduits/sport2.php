        ...
        <div class="main-content">
            ...
            <section class="products">
              ...
              <div class="product">
                ...
                <span>189.00 TND</span> <br><br><center><button class="ajouter"> ajouter au panier</button> </center>
              </div>
              ...
              <div class="product">
                ...
                <span>14.99 TND</span><br><br> <center><button class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
                <img src="../produits/pd3.jpg" alt="Product 2">
                <h3>Barre fixe murale </h3>
                <p>Poignet noir/jaune</p>
                <span>69.90 TND</span> <br><br><center><button class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
                <img src="../produits/pd4.jpg" alt="Product 2">
                <h3>Hummel Tenue d'entrainement enfant </h3>
                <p>T96100 JR-2002- Noir&Gris</p>
                <span>59.90 TND</span><br><br> <center><button class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
                <img src="../produits/pd5.jpg" alt="Product 2">
                <h3>Hummel Tenue Promo Jaune</h3>
                <p>t96100-7000 Gris</p>
                <span>49.90 TND</span> <br><br><center><button class="ajouter"> ajouter au panier</button> </center>
              </div>
              ...
              <div class="product">
                ...
                <span>199.00 TND</span><br><br> <center><button class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
