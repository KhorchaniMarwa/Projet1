        ...
        <div class="main-content">
            ...
            <section class="products">
              ...
              <div class="product">
                ...
                <span>39.90 TND</span><br><br> <center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
                ...
                <span>60.00 TND</span> <br><br><center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
              ...
              <div class="product">
                ...
                <span>13.80 TND</span><br><br> <center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
              <div class="product">
                <img src="../produits/prd9.jpg" alt="Product 2">
                <h3>Generic Casque </h3>
                <p>Bluetooth - MP3 - P47 – Blanc</p>
                <span>16.10 TND</span><br><br> <center><button onclick="ajout()" class="ajouter"> ajouter au panier</button> </center>
              </div>
